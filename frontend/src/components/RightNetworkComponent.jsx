...
const RightNetworkComponent = ({ networkState, setNetworkState }) => {
    return (
        <div className='flex flex-col p-4 sticky top-0'>
            ...
            {networkState === 'Network' && <NetworkComponent networkState={'Network'} />}
            {networkState === 'Connections' && <NetworkComponent networkState={'Connections'} />}
            {networkState === 'Requests' && <NetworkComponent networkState={'Requests'} />}
        </div>
    )
}
